...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNoResource() {
        return envelope(HttpStatus.NOT_FOUND, "NOT_FOUND", "Not found");
    }
    ...
    private static HttpStatus statusFor(NexusErrorCode code) {
        return switch (code) {
            case PROJECT_NOT_FOUND, CONTAINER_NOT_FOUND, DEPLOYMENT_NOT_FOUND, ALERT_NOT_FOUND,
                    SECURITY_FINDING_NOT_FOUND, MANIFEST_NOT_FOUND, DATABASE_NOT_FOUND,
                    GITHUB_NOT_CONNECTED, GITHUB_BRANCH_NOT_FOUND, PROJECT_GITHUB_NOT_LINKED,
                    ENV_VAR_NOT_FOUND, DOMAIN_NOT_FOUND, BACKUP_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case DEPLOYMENT_IN_PROGRESS, INVALID_TRANSITION, CONFIRMATION_REQUIRED,
                    DOMAIN_HOSTNAME_DUPLICATE -> HttpStatus.CONFLICT;
            case MANIFEST_INVALID, OPERATION_NOT_ALLOWED, AUTH_INVALID, QUERY_FAILED,
                    GITHUB_OAUTH_FAILED, GITHUB_OAUTH_STATE_INVALID, GITHUB_CHECKOUT_FAILED,
                    DOMAIN_HOSTNAME_INVALID, BACKUP_RESTORE_FAILED -> HttpStatus.BAD_REQUEST;
            ...
            case GITHUB_NOT_CONFIGURED -> HttpStatus.SERVICE_UNAVAILABLE;
            case GITHUB_WEBHOOK_INVALID -> HttpStatus.UNAUTHORIZED;
        };
    }
}
